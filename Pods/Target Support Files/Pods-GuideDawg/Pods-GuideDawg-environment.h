...
// kingpin
#define COCOAPODS_POD_AVAILABLE_kingpin
#define COCOAPODS_VERSION_MAJOR_kingpin 0
#define COCOAPODS_VERSION_MINOR_kingpin 1
#define COCOAPODS_VERSION_PATCH_kingpin 4
